...
namespace Kbg.NppPluginNET
{
    class Main
    {
        ...
        internal static void CommandMenuInit()
        {
            ...
            PluginBase.SetCommand(0, "Sean's Menu Command", myMenuFunction, new ShortcutKey(false, false, false, Keys.None));
            PluginBase.SetCommand(1, "Sean's Dialogue Thingum", myDockableDialog); idMyDlg = 1;
        }
        ...
        internal static void myDockableDialog()
        {
            if (frmMyDlg == null)
            {
                ...
                _nppTbData.pszName = "Sean's dockable dialog";
